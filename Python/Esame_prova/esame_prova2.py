class Ticket():
    ...
    def book(self, is_booked:bool)-> None:
    ...
    def cancel (self, is_booked:bool)->None:
...
class Cinema():
    ...
    def __init__(self, tickets:dict[str, Ticket], viewer:dict[str, Viewer]):
    ...
    def  book_ticket(self, viewer_id: str, ticket_id: str) -> None: 
        ...
        if viewer_id in self.viewers and ticket_id in self.tickets:
            ...
            viewer_id.book_ticket(ticket_id)
    ...
    def cancel_ticket(self, viewer_id: str, ticket_id: str) -> None:
        ...
        if viewer_id in self.viewers and ticket_id in self.tickets:
            viewer = self.viewers[viewer_id]
            ticket = self.tickets[ticket_id]
            viewer_id.cancel_ticket(ticket_id)
    ...
    def list_viewer_bookings(self,viewer_id: str) -> list[str] | str:
        ...
        if viewer_id:
            ...
            print("Errore: spettatore non trovato.")